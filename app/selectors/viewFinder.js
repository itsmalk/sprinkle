...
export const renderCamera = createSelector(
  ...
  (granted, post) => {
    ...
    return !!(post.swiperIndex === 0 &&
      (!post.selectedPhoto || post.selectedPhoto.src === 'photos'));
  },
);
...
export const showCropButton = createSelector(
  selectedPhoto,
  renderCamera,
  (selectedPhoto, renderCamera) =>
    !!(!renderCamera && selectedPhoto && selectedPhoto.src === 'photos'),
);
